  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row bg-background">
      ...
      <div className="relative hidden w-full flex-col justify-between bg-slate-950 border-r border-white/10 md:flex md:w-5/12 lg:w-5/12 p-10 overflow-hidden">
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-10 h-72 w-72 rounded-full bg-sky-500/10 blur-3xl pointer-events-none" />
        <div className="absolute bottom-10 right-10 h-80 w-80 rounded-full bg-cyan-500/10 blur-3xl pointer-events-none" />

        <div className="relative z-10 flex items-center gap-2.5 font-extrabold text-2xl tracking-tight text-foreground">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-sky-400 to-cyan-500 text-slate-950 shadow-md">
        ...
        <div className="relative z-10 my-auto space-y-6 max-w-md py-12">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-black tracking-wider uppercase bg-sky-500/10 text-sky-400 border border-sky-400/20">
