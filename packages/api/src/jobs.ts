...
export const jobsApi = {
  getJobFeed: (page = 1, limit = 10) => 
    api.get<Job[]>(API_ENDPOINTS.JOBS.FEED, { params: { page, limit } }),
  ...
  getSavedJobs: (page = 1) => 
    api.get<SavedJob[]>(API_ENDPOINTS.JOBS.SAVED, { params: { page } }),
    
  getApplications: (page = 1) => 
    api.get<Application[]>(API_ENDPOINTS.APPLICATIONS.LIST, { params: { page } }),
